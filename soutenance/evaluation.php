				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>GRILLE DE NOTATION DU RAPPORT DE STAGE DE FIN DE FORMATION </h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Soutenance</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Grille de notation</a></li>
                             </ol>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="titre_du_sujet" value="<?php echo strtoupper($etudiant['theme']);?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress" style="background: rgba(127, 99, 244, .1)">
                                                        <div class="progress-bar bg-success" style="width: <?php echo round((getNoteElement($soutenance,$element['libelle_element'],$_SESSION['etablissement'],$connexion)*100)/$element['note_max'],1);?>%;" role="progressbar"><span class="sr-only"></span>
                                                        </div>
                                                    </div>
                                                </td>
                                        ...
                                        <td>  
                                            ...
                                            ?>
                                                <form method="post" action="traitement">    
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                                            <input class="form-control form-control-sm"  type="number" name="note" min="0" max="<?php echo $element['note_max'];?>" value="<?php echo getNoteElement($soutenance,$element['libelle_element'],$_SESSION['etablissement'],$connexion);?>">
                                                        </div>
                                                        <div class="col-lg-2">
                                                            <input type="hidden" name="element" value="<?php echo $element['libelle_element'];?>">
                                                            <input type="hidden" name="soutenance" value="<?php echo $soutenance;?>">

                
                                                           <button type="submit" class="btn btn-primary"  ><i class="fa fa-pencil color-muted"></i> </button> 
                                                        </div>
                                                    </div>
                                                ...
                                                <?php }else{?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2">
                                                           ...
                                                           <button type="submit" class="btn btn-info"  ><i class="fa fa-edit color-muted"></i> </button> 
                                                        </div>
                                                    </div>
                                                ...
                                                <td><span class="badge badge-success"><?php echo $element['note_max'];?></span>
                                                </td>
                                                    ...
                                                    <div class="col-md-6 no-gutters">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <label for="">Note soutenance</label>
                                                              <input class="form-control form-control-lg"  value="<?php echo $note_soutenance;?>" type="number" name="note_modif" min="0" max="20">
                                                              <br>
                                                              <p> Mention : <?php echo mentionParmoyenne($note_soutenance);?></p>
                                                            </div>  
                                                             
                                                        <div class="col-6 mx-auto">
                                                        <button type="submit" class="btn btn-success"  ><i class="fa fa-pencil color-muted"></i> Modifier</button> 
                                                        <a href="impression?soutenance=<?php echo $soutenance;?>" class="btn btn-light" type="button"> <i class="fa fa-print"></i> Imprimer </a>
                                                        </div>
                                                       </div>
