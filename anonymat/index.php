								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from anonymat where etab='".$_SESSION['etablissement']."' ORDER BY annee DESC, ecue, classe, numero";
                                                 $resultat =$connexion->query($sql);
                                                 $count=1;
...
<div id="printArea" style="display:none;"></div>
    ...
    ***********************************-->
    ...
    $(document).ready(function() {
        ...
        // -------------------------------------------------------
        // Affichage du modal message (succès / erreur) via URL
        // -------------------------------------------------------
            ...
            var printContent = `
                ...
                <head>
                    ...
                    <style>
                        ...
                        .code-cell { font-weight: bold; font-size: 16px; color: #d9534f; text-align: center; }
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Matricule</th>
                                <th>Nom et Prénom</th>
                                <th style="width: 150px;">Code Anonyme</th>
                            </tr>
                        </thead>
                        <tbody>
            `;
