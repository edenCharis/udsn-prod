				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Cumule des heures effectuées</h3>
                        </div>
                    </div>
						...
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Classe : <?php echo $classe;?></h4>
									<h4 class="card-title">Année : <?php echo $annee;?></h4>
									...
									<table id="example3" class="display" style="min-width: 845px">
										<thead>
											<tr>
                                                ...
                                                <th>Total d'heures effectuées</th>
                                                <th>Mois</th>
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from cumule where etab='".$_SESSION['etablissement']."' and classe='".$_GET["classe"]."' and annee='".$_GET["annee"]."'";                                             $resultat =$connexion->query($sql);
                                                 $count =1;
                                          ...
                                          ?>
											<tr>
                                                ...
                                                <td><?php echo $ue['total_heures'];?></td>
                                                <td><?php echo translateMonth($ue['mois']);?></td>	
