...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="cours"){
     ...
     if(isset($_GET["voir"])){
        ...
        header("location: suivi_dashboard?semestre=$semestre&annee=$annee&classe=$classe&etablissement=".$_SESSION["etablissement"]);
    }
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Monitoring de l'état d'avancement des cours</h3>
                        </div>
                    </div>
                                ...
                                <div class="basic-form">
                                    <form method="get">
                                        ...
                                        <div class="form-row">
                                         ...
                                         <button type="submit" class="btn btn-danger" name="voir"><i class="la la-eye"></i>Consulter</button>
                                    </form>
