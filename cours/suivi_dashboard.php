...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="cours"){
     ...
     if(isset($_GET["classe"]) and isset($_GET["semestre"]) and isset($_GET["annee"])){
        ...
        $liste_ecues = getECUEsByClassSemesterYear($classe, $semestre, $annee,$_SESSION["etablissement"], $connexion1);
...
<body>
    ...
    ***********************************-->
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-12 p-md-0">
                        <div class="welcome-text">
                            <h1 class="text-warning">Suivi de l'état d'avancement des cours </h1>
                    ...
                    <div class="col-sm-4 p-md-0">
                             <h5> <span class="text-secondary">Classe</span> : <?php echo $classe;  ?></h5>
                        </div>
                         <div class="col-sm-4 p-md-0">
                             <h5> <span class="text-secondary">Semestre</span> : <?php echo $semestre;  ?></h5>
                        </div>
                         <div class="col-sm-4 p-md-0">
                             <h5> <span class="text-secondary">Semestre</span> : <?php echo $annee;  ?></h5>
                        </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        <?php 
        foreach ($liste_ecues as $l) {
            $enseignant = $l->nom."  ".$l->prenom;
            $hour = getCompletedHours($l->code_ecue, $classe, $semestre, $annee, $_SESSION["etablissement"], $connexion1);
            $completion_percentage = ($hour / $l->vhg) * 100;
    ...
    $enseignant."
                    ...
                    <div class='card-body'>
                        <h5 class='card-title'>". str_replace('+', "'", getecue($l->code_ecue, $connexion)) ."</h5>
                        <div class='progress' style='height: 30px;'>
                            <div 
                                class='progress-bar progress-bar-striped progress-bar-animated' 
                                role='progressbar' 
                                style='width: " . round($completion_percentage, 2) . "%;' 
                                aria-valuenow='" . round($completion_percentage, 2) . "' 
                                aria-valuemin='0' 
                                aria-valuemax='100'>
                                " . round($completion_percentage, 2) . "%
                            </div>
                        </div>
                        <small class='text-muted'>Heures effectuées : $hour / $l->vhg</small>
                    </div>
                </div>
            </div>";
        }
