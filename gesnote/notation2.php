...
if($_POST && isset($_POST['sauvegarder_notes'])) {
    ...
    $erreurs = [];
    $succes = 0;
    $debug_messages = [] ; // ✅ Pour stocker les messages de debug
    ...
    // Traitement de suppression (garder l'ancien code)
    if(isset($_GET['sup'])){
        $id = $_GET['sup'];
    ...
    // Récupération des étudiants si les critères sont sélectionnés
    $etudiants = [];
    $notes_existantes = [];
    $show_table = false;
    
    if(isset($_GET['ecue']) && isset($_GET['classe']) && isset($_GET['semestre']) && isset($_GET['annee']) && isset($_GET['type_evaluation'])) {
        $ecue = $_GET['ecue'];
        $classe = $_GET['classe'];
        $semestre = $_GET['semestre'];
        $annee = $_GET['annee'];
        ...
        $sql_etudiants = "SELECT i.id, i.candidat FROM inscription i 
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Saisie simplifiée des notes</h4>
                                <small class="text-muted">Sélectionnez les critères pour afficher tous les étudiants d'un coup</small>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="classe" class="disabling-options" required>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $classe_item['libelle'];?>" 
                                                        <?php echo (isset($_GET['classe']) && $_GET['classe'] == $classe_item['libelle']) ? 'selected' : ''; ?>>
                                                        <?php echo str_replace("+","'",$classe_item['libelle']);?>
                                                    </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="ecue" class="disabling-options" required>
                                                    <option value="">Sélectionner</option>
                                                    <?php 
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="semestre" class="disabling-options" required>
                                                    <option value="">Sélectionner</option>
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $semestre_item['libelle'];?>"
                                                        <?php echo (isset($_GET['semestre']) && $_GET['semestre'] == $semestre_item['libelle']) ? 'selected' : ''; ?>>
                                                        <?php echo str_replace("+","'",$semestre_item['libelle']);?>
                                                    </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="annee" class="disabling-options" required>
                                                    <option value="">Sélectionner</option>
                                                    <?php 
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $annee_item['libelle'];?>"
                                                        <?php echo (isset($_GET['annee']) && $_GET['annee'] == $annee_item['libelle']) ? 'selected' : ''; ?>>
                                                        <?php echo str_replace("+","'",$annee_item['libelle']);?>
                                                    </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
            ...
            <div class="card-header">
                ...
                <div class="float-right">
                    <small class="text-muted">
                        <?php 
                        $ecue_info = $connexion->query("SELECT libelle FROM ecue WHERE code_ecue='$ecue'")->fetch_assoc();
                        echo str_replace("+", "'", $ecue_info['libelle']);
                        ?> | <?php echo $semestre; ?> - <?php echo $annee; ?> | <?php echo $type_evaluation; ?>
                        <br><span id="compteur-notes">0</span> / <?php echo count($etudiants); ?> étudiants notés
                    </small>
                </div>
            </div>
            <div class="card-body">
...
<div class="modal" id="messageModal" tabindex="-1" role="dialog" aria-labelledby="messageModalLabel" aria-hidden="true">
    ...
    ***********************************-->
    ...
    function updateCompteur() {
        ...
        document.getElementById('compteur-notes').textContent = counted;
    }
