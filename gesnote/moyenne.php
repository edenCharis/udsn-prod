				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Resultats definitifs</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Moyennes générales par semestre</h4>
								<a href="imprimer" class="btn btn-lg btn-primary" ><i class="fa fa-print"></i> Imprimer</a>
							</div>
							<div class="card-body">
...
<td>
                                                        <?php 
                                                              ...
                                                              $moyenne = round(calcul_moyenne($ue['inscription'],$ue['semestre'],$ue['annee'],$ue['etab'],$connexion),2);

                                                             echo  ($moyenne >= 10 ?   "Admis" : "Echoué");
                                                        ?>
                                                     </td>	
...
?>
                                                <a class="btn btn-primary" data-toggle="modal" data-target="#modifierModal" data-id="<?php echo $ue['id']?>" ><i class="la la-list"></i>Ecues non validées</a>
													<?php }?>		
                                                     </td>	
