            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-8 p-md-0">
                        <div class="welcome-text">
                            <h4>RENOUVELLEMENT D'UN CONTRAT D'ENSEIGNEMENT </h4>
                        </div>
                    </div>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                               ...
                                               <?php 
                                                ...
                                                ?>
                                                 <option value="<?php echo $etablissement["id"];?>"><?php echo str_replace("+","'",$etablissement['nom']. " " .$etablissement["prenom"]);?></option>
                                                 <?php }?>
                                            </select>
									 </div>
								</div>
