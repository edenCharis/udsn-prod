...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="scolarité"){
    ...
    if( isset($_GET["generer"])){
        ...
        $niveau = NiveauParSemestre($semestre);
          ...
          $_SESSION["lien"]="www.udsn.site/h?spec=$spec&semestre=$semestre&examen=$examen&niveau=$niveau&annee=$annee&etablissement=".$_SESSION["etablissement"];
                ...
                <div class="col-md-12 text-center">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="generer_pv" class="btn btn-danger no-print">
    <i class="fa fa-print"></i> Imprimer le PV officiel
</a>
                            </div>
                                    ...
                                    <form method="get">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-sm-3">
                                              ...
                                              <div class="form-group col-sm-3">
                                                <label>Classe</label>
                                                <select   class="disabling-options" class="form-control form-control-lg" name="classe" required >
                                                <option selected=""></option>
                                               <?php 
