...
<h3 class="custom-font"><b> <?php //$code = getCodeEnseignant($id,$connexion);
              ...
              echo mettrePremieresLettresMajuscules(getPrenom($id,$connexion))."  ".getNom($id,$connexion);?></b><br><?php echo mettrePremieresLettresMajuscules( getGradeById($id,$connexion));?> CAMES</h3>
