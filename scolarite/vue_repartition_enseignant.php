				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Repartition des Enseignants par classe</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../scolarite/ecue">Ecues</a></li>
                              <li class="breadcrumb-item"><a href="../scolarite/enseignant">Enseignants</a></li>
                            <li class="breadcrumb-item"><a href="../scolarite/repartition">Repartition Ecues/Classes</a></li>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          <?php 
                                                 $sql ="select DISTINCT * from repartition_enseignant where etab='".$_SESSION['etablissement']."'";
