				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Historique des grades des enseignants</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../scolarite/">Scolarité</a></li>
                            <li class="breadcrumb-item"><a href="enseignant">Enseignants</a></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								...
								<a href="add-library.html" class="btn btn-primary" data-toggle="modal" data-target="#typeAgentModal">+ Mettre a jour</a>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from grade where etab='".$_SESSION['etablissement']."'";
                                          ...
                                          ?>
											<tr>
												...
												<td><?php echo str_replace("+","'", getNomEnseignant( $ue['enseignant'],$connexion))."   ".str_replace("+","'", getPrenomEnseignant( $ue['enseignant'],$connexion));?></td>
												<td><?php echo $ue['libelle_grade'];?></td>
                                                ...
                                                <?php /* ?>
                                                    ...
                                                    data-ens="<?php echo  str_replace("+","'",getNomPrenomEnseignant($ue['enseignant'],$connexion));?>"   data-grade="<?php echo $ue['libelle_grade'];?>"  data-dip="<?php echo $ue['diplome'];?>"
                                                      data-th="<?php echo $ue['th'];?>"  data-annee="<?php echo $ue['annee']; ?>"><i class="la la-pencil"></i></a>

                                                      <?php */ ?>
                                                    <a href="traitement2?suphisto=<?php echo $ue['id'];?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                                </td>												
											</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le grade d'un enseignant</h5>
            ...
            <div class="modal-body">
                ...
                <form  method="post" action="traitement2">
                    ...
                    <div class="form-group">
                        <label for="nouveauTh">Taux Horaire </label>
                        <input type="text" class="form-control" id="nouveauTh" name="nouveauTh" >
                    </div>
                    ...
                    <div class="form-group">
                        <label for="nouveauAn">Année d'obtention</label>
                        <input type="text" class="form-control" id="nouveauAn" name="nouveauAn" required>
                    </div>
...
<div class="modal fade" id="typeAgentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Mise à jour  d'un grade enseignant</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="enseignant" class="disabling-options" name="enseignant" required>
                                                <option selected=""></option>
                                               <?php 
                                                        ...
                                                        while($etablissement =$resultat->fetch_assoc()){
                                                ?>
                                                 <option value="<?php echo $etablissement['code'];?>"><?php echo str_replace("+","'",getNomPrenomEnseignant($etablissement['code'],$connexion));?></option>
                                                 <?php }?>
                                            </select>
                    </div>
                    <div class="form-group">
                        <label for="th">Taux Horaire </label>
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="diplome" class="disabling-options" name="diplome" >
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from type_diplome ";
                                                        $resultat=$connexion->query($sql);
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-primary').click(function() {
            ...
            var id = $(this).data('id');
            var nom = $(this).data('ens');
            var grade=  $(this).data('grade');
            var dip = $(this).data('dip');
            var st = $(this).data('annee');
            var th=$(this).data('th');
