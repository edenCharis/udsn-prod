...
<head>
    ...
    <title>SGUDSN - Scolarité de  <?php echo $_SESSION['etablissement'];?> </title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Formulaire de retrait d'un ECUE a un Enseignant</h3>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../scolarite/">Scolarité</a></li>
                            <li class="breadcrumb-item"><a href="affectation">Affectation des ecues</a></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Liste des ecues rétirés</h4>
								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from retrait where etab='".$_SESSION['etablissement']."'";
											...
											<tr>
												...
												<td>
                                                    ...
                                                    <a href="traitement1" class="btn btn-sm btn-primary " data-toggle="modal" data-target="#modifierModal" data-id="<?php echo $ue['id'];?>"
                                                      data-ecue="<?php echo str_replace("+","'",$ue['ecue']);?>"  data-classe="<?php echo $ue['classe'];?>"
