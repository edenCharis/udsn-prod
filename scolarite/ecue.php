...
<body>
   ...
   href="modifier_ecue?id=<?php echo urlencode($ue['id']); ?>&code_ecue=<?php echo urlencode($ue['code_ecue']); ?>&lib=<?php echo urlencode($ue['libelle']); ?>&vhcm=<?php echo urlencode($ue['VHCM']); ?>&vhtp=<?php echo urlencode($ue['VHTP']); ?>&vhtd=<?php echo urlencode($ue['VHTD']); ?>&cr=<?php echo urlencode($ue['credit']); ?>&ue=<?php echo urlencode($ue['code_ue']); ?>">
