...
<div class="page">
  ...
  <div class="filtres-actifs">
    <span class="badge-filtre badge-examen">
      📋 <?php echo htmlspecialchars($label_examen); ?>
    </span>
    <?php if (!empty($filtre_annee)): ?>
    <span class="badge-filtre badge-annee">
      📅 Année : <?php echo htmlspecialchars($filtre_annee); ?>
    </span>
    <?php else: ?>
    <span class="badge-filtre badge-annee">📅 Toutes années</span>
    <?php endif; ?>
    <?php if (!empty($filtre_parcours)): ?>
    <span class="badge-filtre badge-parcours">
      🎓 Parcours : <?php echo htmlspecialchars($filtre_parcours); ?>
    </span>
    <?php else: ?>
    <span class="badge-filtre badge-parcours">🎓 Tous parcours</span>
    <?php endif; ?>
  </div>
  ...
  <div class="stats-row">
    <div class="stat-box stat-total">
      <div class="stat-nb"><?php echo $nb_total; ?></div>
      <div class="stat-label">Total</div>
    </div>
    <div class="stat-box stat-valides">
      <div class="stat-nb"><?php echo $nb_valides; ?></div>
      <div class="stat-label">Validés</div>
    </div>
    <div class="stat-box stat-ajournes">
      <div class="stat-nb"><?php echo $nb_ajournes; ?></div>
      <div class="stat-label">Ajournés</div>
    </div>
    <?php if ($nb_total > 0): ?>
    <div class="stat-box" style="border-color:#8e44ad;">
      <div class="stat-nb" style="color:#8e44ad;"><?php echo round($nb_valides / $nb_total * 100, 1); ?>%</div>
  ...
  <table class="table-recap">
    ...
    ?>
      <tr>
        ...
        <td><?php echo htmlspecialchars($parc_etud); ?></td>
        <td><?php echo htmlspecialchars($spec_etud); ?></td>
        <td style="text-align:center;"><?php echo htmlspecialchars($ue->semestre); ?></td>
        <td style="text-align:center;"><?php echo htmlspecialchars($ue->examen); ?></td>
        <td style="text-align:center;"><?php echo htmlspecialchars($ue->annee); ?></td>
