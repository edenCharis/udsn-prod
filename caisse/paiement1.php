...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="caisse"){
    ...
    if(isset($_GET['sup'])){
        ...
        $connexion->query("delete from paiement where id=".$_GET['sup']);

        $id =$_GET['sup'];
        $userIP = $_SERVER['REMOTE_ADDR'];

            logUserAction($connexion,$_SESSION['id_user'],"suppression d'un paiement ",date("Y-m-d H:i:s"),$userIP,"valeur supprimé : $id");
           

        header("location: paiement1");
    }
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Gestion des paiements des heures effectuées par les enseignants</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Caisse</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Gestion des paiements</a></li>
                             </ol>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $frais['code'];?></td>
                                                <td><?php echo getNomPrenomEnseignant($frais['agent'],$connexion); ?></td>
                                                <td><?php echo getNomMois($frais['mois']);?></td>
                                               
                                                <td><?php echo $frais['heure_eff']?></td>
                                                <td><?php echo $frais['annee']?></td>
                                                <td><?php echo $frais['montant_a_pay']?></td>
                                                <td><?php echo $frais['montant_pay']?></td>
                                                <td><?php echo $frais['montant_a_pay']-$frais['montant_pay']; ?></td>
                                                <td><?php echo $frais['etab']?></td>
                                                <td>
                                                   <a href="paiement1?sup=<?php echo $frais['id'];?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                               </td>
                                            </tr>
                                          <?php }?>
...
<div class="modal fade" id="typeAgentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                        ...
                        <label for="enseignant">Matricule de l'enseignant </label>
                        <input type="text"  class="form-control" id="enseignant" name="enseignant" required>
                                            ...
                                            <select name="mois" class="disabling-options">
                                                <option value=""></option>
    ...
    <option value="12">Décembre</option>
                            ...
                            <div class="form-group">
                       <label for="hef">Heures effectuées </label>
                       <input type="number"  class="form-control" id="hef" name="hef" required>
                      </div>
                   
                                           
                     <div class="form-group">
                       <label for="mp">Montant payé </label>
                    ...
                    <div class="form-group">
                    <label for="annee">Etablissement </label>
