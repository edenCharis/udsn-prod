					...
					<div class="col-lg-12">
						<div class="card">
                            <div class="card-header">
                                ...
                                <a href="paiement2" class="btn btn-success" >Paiement</a>
							</div>
                            <div class="card-body">
                                ...
                                <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $frais['annee_inscription']?></td>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="inscription" class="disabling-options" class="form-control form-control-lg" name="inscription" required>
                       ...
                       <div class="input-group mb-3">
                                            ...
                                            <select id="ecue" class="disabling-options" name="etablissement" required>
                                                <option selected=""></option>
                                               <?php 
