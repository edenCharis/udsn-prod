...
<a href="#" class="brand-logo">
     ...
     <span class="titre d-none d-md-inline text-white"><?php echo $_SESSION['univ']; ?></span>
                        ...
                        <div class="header-left">
                            <div class="search_bar dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0">
                                    <form>
                                        <input class="form-control" type="search" placeholder="Code de l'enseignant" name="search" aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
