                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="table table-sm mb-0">
                                        ...
                                        $sql =" select * from userlog   ORDER BY datetime DESC";
                                   ...
                                   ?>
                                            <tr class="btn-reveal-trigger">
                                                ...
                                                <td class="py-2">
                                                    <a href="#">
                                                        <strong><?php echo $log['LogID'];?></strong></a>
...
<div class="modal fade" id="moncompte" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
