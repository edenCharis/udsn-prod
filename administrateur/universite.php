				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Création d'une université</h4>
                        </div>
                    </div>
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													...
													<tr>
														...
														<td><a href="javascript:void(0);"><?php echo str_replace("+","'",$type['libelle_univ']);?></td>
                                                        <td><a href="javascript:void(0);"><?php echo str_replace("+","'",$type['email_contact']);?></td>
                                                        <td><a href="javascript:void(0);"><?php echo $type['tel_contact'];?></td>
                                                        <td><a href="javascript:void(0);"><?php echo $type['fax'];?></td>
                                                        <td><a href="javascript:void(0);"><?php echo $type['long_univ'];?></td>
                                                        <td><a href="javascript:void(0);"><?php echo $type['lat_univ'];?></td>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier l'université</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
