...
<head>
    ...
    <title>SGUDSN - Administrateur </title>
    <!-- Favicon icon -->
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des parcours d'études</h4>
                        </div>
                    </div>
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td><a href="javascript:void(0);"><?php $etab =  str_replace("+","'",$type['etab']); echo $etab;?></td>
														
														<td>
                                                            <a class="btn btn-primary" data-toggle="modal" data-target="#modifierModal" data-id="<?php echo $type['id']?>" data-etab="<?php echo $etab;?>" data-type="<?php echo str_replace("+","'",$type['libelle']);?>"><i class="la la-pencil"></i>Modifier</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'un parcours</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        <label for="typepar">Libellé Parcours :</label>
                        <input type="text" class="form-control" id="typepar" name="typepar" placeholder="Entrez le parcours" required>
                    </div>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le parcours</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form  method="post" action="traitement">
                    ...
                    <div class="form-group">
                        <label for="nouveauPar">Nouveau parcours :</label>
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauEtab" class="" name="nouveauEtab" required>
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from etablissement where libelle <> 'udsn' ";
                                                        $resultat=$connexion->query($sql);
