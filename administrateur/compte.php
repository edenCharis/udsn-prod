									...
									<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
                                                    <?php 
                                                      $sql ="select * from utilisateur where etab is null  and role ='administrateur' and univ is not null";
													...
													<tr>
                                                        ...
                                                        <td><?php echo str_replace("+","'",$type['statut']);?></td>
                                                          <td><a href="etablissement"><?php $etab =  str_replace("+","'",$type['univ']); echo $etab;?></td>
														...
														<td>
                                                              ...
                                                              <?php 
                                                                  if($type['statut'] == "O"){
                                                              ?>
                                                            <a  href="traitement3?statut=N&id=<?php echo $type['id'];?>" class="btn btn-info" ><i class="la la-pencil"></i>Desactiver</a>

                                                            <?php }else{?>
                                                                <a href="traitement3?statut=O&id=<?php echo $type['id'];?>" class="btn btn-success" ><i class="la la-pencil"></i>Activer</a>
                                                                <?php }  ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement1" enctype="multipart/form-data">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                       ...
                       <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <label class="input-group-text">Université : </label>
                                            </div>
                                            <select id="etab" class="" name="etab" required>
                                               ...
                                               <?php 
                                                ...
                                                ?>
                                                 <option value="<?php echo $etablissement['code'];?>"><?php echo str_replace("+","'",$etablissement['libelle_univ']);?></option>
                                                 <?php }?>
                                            </select>
                       </div>
		...
		for(var i=0; i < liste.length; i++)
		{
			liste[i].addEventListener('click',function(event){
				...
				document.getElementById('lien').addEventListener('click',function(){
                       window.location.href='traitement4?supcompte='+id ;
				})
			})
