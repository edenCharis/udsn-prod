				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des types de grade des enseignants</h4>
                        </div>
                    </div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Liste des types des grade </h4>
											...
											<table id="example3" class="display" style="min-width: 845px">
												<thead>
													<tr>
														...
														<th>ID. Type de grade</th>
														<th>Libéllé Type de grade</th>
                                                        <th>Taux Horaire</th>
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $type['th'];?></td>
														<td>
                                                            <a class="btn btn-primary" data-toggle="modal" data-target="#modifierModal" data-id="<?php echo $type['id']?>" data-th="<?php echo $type['th'] ;?>" data-type="<?php echo str_replace("+","'",$type['libelle']);?>"><i class="la la-pencil"></i>Modifier</a>
															<a class="btn btn-danger" href="traitement?supgrade=<?php echo $type['id'];?>" ><i class="la la-trash-o"></i>Supprimer</a>
														</td>												
													</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement du Type de grade</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        <label for="typegrade">Type de grade :</label>
                        <input type="text" class="form-control" id="typegrade" name="typegrade" placeholder="Entrez le type de grade" required>
                    </div>
                    <div class="form-group">
                        <label for="typegrade">Taux Horaire :</label>
                        <input type="number" class="form-control" id="th" name="th" placeholder="Entrez le taux horaire" required>
                    </div>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le Type de grade</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form  method="post" action="traitement">
                    <input type="number" id="gradeId" name="gradeId">
                    <div class="form-group">
                        <label for="nouveauType">Nouveau Type de grade :</label>
                        <input type="text" class="form-control" id="nouveauType" name="nouveauType" required>
                    </div>
                    <div class="form-group">
                        <label for="nouveauType">Nouveau Taux horaire :</label>
                        <input type="number" class="form-control" id="nouveauTh" name="nouveauTh" required>
                    </div>
