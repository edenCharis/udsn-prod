				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des types de document</h4>
                        </div>
                    </div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Liste des types de document </h4>
											...
											<table id="example3" class="display" style="min-width: 845px">
												<thead>
													<tr>
														...
														<th>ID. Type de document</th>
														<th>Libéllé Type de document</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a class="btn btn-danger" href="traitement?suppressiondoc=<?php echo $type['id'];?>" ><i class="la la-trash-o"></i>Supprimer</a>
														</td>												
													</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement du Type de document</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="typedoc" name="typedoc" placeholder="Entrez le type de document" required>
                    </div>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le Type de document</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
