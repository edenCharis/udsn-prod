				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des types de frais</h4>
                        </div>
                    </div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Liste des types des frais </h4>
											...
											<table id="example3" class="display" style="min-width: 845px">
												<thead>
													<tr>
														...
														<th>ID. Type de frais</th>
														<th>Libéllé Type de frais</th>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a class="btn btn-danger" href="traitement?supfrais=<?php echo $type['id'];?>" ><i class="la la-trash-o"></i>Supprimer</a>
														</td>												
													</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement du Type de frais</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="typefrais" name="typefrais" placeholder="Entrez le type de frais" required>
                    </div>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le Type de frais</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form  method="post" action="traitement">
                    <input type="hidden" id="fraisId" name="fraisId">
                    <div class="form-group">
                        <label for="nouveauType">Nouveau Type de frais:</label>
