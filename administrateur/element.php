				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des elements de PV de soutenances</h4>
                        </div>
                    </div>
											...
											<table id="example3" class="display" style="min-width: 845px">
												...
												<tbody>
													...
													<tr>
														...
														<td><a href="javascript:void(0);"><?php echo str_replace("+","'",$type['libelle_element']);?></td>
                                                        <td><?php echo $type['type_element'];?></td>
                                                        <td><?php echo $type['note_max'];?></td>
														<td>
                                                           <a class="btn btn-danger" href="traitement?supe=<?php echo $type['id'];?>" ><i class="la la-trash-o"></i>Supprimer</a>
														</td>												
													</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'un element</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        <label for="element">Libellé  element :</label>
...
<?php 
                                                ...
                                                ?>
                                                 <option><?php echo str_replace("+","'",$etablissement['libelle_type']);?></option>
                                                 <?php }?>
</select>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form  method="post" action="traitement">
                    <input type="hidden" id="TEID" name="TEID">
                    <div class="form-group">
                        <label for="TE">Nouveau type d'element :</label>
                        <input type="text" class="form-control" id="TE" name="TE" required>
                    </div>
                    <div class="form-group">
                        <label for="note_maxi">Note Maximale:</label>
                        <input type="number" class="form-control" id="note_maxi" name="note_max" required>
                    </div>
