				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Paramétrage des semestres</h4>
                        </div>
                    </div>
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<a class="btn btn-danger" href="traitement?supsem=<?php echo $type['id'];?>" ><i class="la la-trash-o"></i>Supprimer</a>
														</td>												
													</tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enregistrement d'un semestre</h5>
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement">
                    <div class="form-group">
                        <label for="typesem">Type de semestre :</label>
                        <input type="text" class="form-control" id="typesem" name="typesem" placeholder="Entrez le semestre" required>
                    </div>
...
<div class="modal" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="modifierModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modifierModalLabel">Modifier le semestre</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form  method="post" action="traitement">
                    ...
                    <div class="form-group">
                        <label for="nouveauType">Nouveau semestre :</label>
