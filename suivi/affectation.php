...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="suivi"){
				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Affectation des ecues aux enseignants</h3>
                        </div>
                    </div>
								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from repartition_enseignant where etab='".$_SESSION['etablissement']."'";
                                          ...
                                          ?>
											<tr>
												...
												<td><?php echo str_replace("+","'", getNomEnseignant( $ue['code'],$connexion))."   ".str_replace("+","'", getPrenomEnseignant( $ue['code'],$connexion));?></td>
            ...
            <div class="modal-body">
                ...
                <form  method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauClasse" class="disabling-options"  name="nouveauClasse" >
                                                <option selected=""></option>
                                               <?php 
                       ...
                       <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauSem" class="disabling-options"  name="nouveauSem" >
                                                <option selected=""></option>
                                               <?php 
                       ...
                       <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauAnnee" class="disabling-options"  name="nouveauAnnee" >
                                                <option selected=""></option>
                                               <?php 
