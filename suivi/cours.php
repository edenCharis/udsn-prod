								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from cours where etab='".$_SESSION['etablissement']."'";
            ...
            <div class="modal-body">
                ...
                <form  method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauClasse" class="form-control disabling-options" name="nouveauClasse" >
                                                <option selected=""></option>
                                               <?php 
                       ...
                       <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauSem" class="form-control disabling-options" name="nouveauSem" >
                                                <option selected=""></option>
                                               <?php 
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="enseignant" class="form-control disabling-options" name="enseignant" required>
                                                <option selected=""></option>
                                               <?php 
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="ecue" class="form-control disabling-options" name="ecue" >
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from ecue where etab='".$_SESSION['etablissement']."'";
                                                        $resultat=$connexion->query($sql);
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="classe" class="form-control disabling-options" name="classe" >
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from classe where etab='".$_SESSION['etablissement']."'";
                                                        $resultat=$connexion->query($sql);
