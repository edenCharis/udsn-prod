                ...
                if(getStatutPaimentCand($_GET['code'],$_GET['annee'],$connexion))
                {
                    ...
                    if($connexion->query($sql)){
                        logUserAction($connexion,$_SESSION['id_user'],"modification statut de paiement candidat ",date("Y-m-d H:i:s"),$userIP,"valeur modifié : $code, statut=".$_GET['statut']);
                          ...
                          header("location: ../scolarite/candidature");
                          exit;
                    }
                }else{
                    $c = $_GET['code'];
                header("location: ../scolarite/candidature?erreur=le candidat  $c n'a pas encore payé les frais d'études du dossier.");
                    exit;
                }
						...
						<div class="row tab-content">
							...
							<div id="grid-view" class="tab-pane fade  col-lg-12">
                                ...
                                <?php 
                                   ...
                                   $sql ="select * from candidat  where etab='".$_SESSION['lib_etab']."' and etat";
							...
							<div class="card-body">
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
                                                ...
                                                if(isset($_GET['bac'])){
                                                    $sql ="select * from candidat where etab='".$_SESSION['lib_etab']."' and moyenneBac >= 12 and etat";
                                                }else if(isset($_GET['statutpaiement'])){
                                                    $sql ="select * from candidat where etab='".$_SESSION['lib_etab']."' and statut_paiement_inscription =1 and etat";
                                                }else{
                                                    $sql ="select * from candidat where etab='".$_SESSION['lib_etab']."' and etat";
                                                ...
                                                ?>
													<tr>
                                                       ...
                                                       // <?php } else{
                                                        ...
                                                        <a href="candidature?sup=<?php echo $candidat['id'];?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                                           <?php } else{
