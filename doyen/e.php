    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Repartition des moyennes des ECUES</h4>
                </div>
            </div>
        ...
        <h4 >
              ...
              <h4 >
                  ...
                  <form method="POST" action="imprimer_ecue.php">
        ...
        <tr>
         ...
         ?>
            ...
            <?php }}?>
                 ...
                 <th > <?php    if(verifierEliminatoire($eliminatoires) == false){echo  "Validé";}else{ echo "Note Eliminatoire";}?></th>
