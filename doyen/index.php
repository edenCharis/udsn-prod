				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="../scolarite/etudiant">etudiants</a></li>
...
$sql_classes = "SELECT COUNT(libelle) as total_classes FROM classe WHERE etab='".$_SESSION["etablissement"]."'";
$result_classes = $connexion->query($sql_classes);
$total_classes = $result_classes->fetch_assoc()['total_classes'];

// Count number of students
$sql_students = "SELECT COUNT(DISTINCT id) as total_students FROM inscription WHERE annee ='".$_SESSION["annee"]."' and etab='".$_SESSION["etablissement"]."'";
...
$sql_ecues = "SELECT COUNT(DISTINCT numero_contrat) as enseignant FROM contrat WHERE annee='".$_SESSION["annee"]."'AND etab='".$_SESSION["etablissement"]."'";
$result_ecues = $connexion->query($sql_ecues);
$enseignant = $result_ecues->fetch_assoc()['enseignant'];

// Count total grades entered
$sql_total_grades = "SELECT COUNT(*) as specialite FROM specialite WHERE etab='".$_SESSION["lib_etab"]."'";
$result_total_grades = $connexion->query($sql_total_grades);
$spec = $result_total_grades->fetch_assoc()['specialite'];
?>
        ...
        <div class="widget-stat card bg-secondary">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white">
                        <p class="mb-1">Contrat d'enseignement</p>
                        <h3 class="text-white"><?php echo $enseignant; ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-stat card bg-success">
            <div class="card-body p-4">
                <div class="media">
                    ...
                    <div class="media-body text-white">
                        <p class="mb-1">Specialités</p>
                        <h3 class="text-white"><?php echo $spec; ?></h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="basic-form">
                                    <form>
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                <select id="classe" class="disabling-options" name="classe" >
                                               ...
                                               <?php 
                                                ...
                                                <div class="col-lg-12">
                                                <select id="annee" class="disabling-options" name="annee" >
                                                <option selected=""></option>
                                               <?php 
                                          ...
                                          ?>
											<tr>
                                                ...
                                                <td><?php echo obtenirSpecialiteClasse($etudiant['classe'],$connexion);?></td>	
                                                 <td><?php echo getParcours(obtenirSpecialiteClasse($etudiant['classe'],$connexion),$connexion);?></td>	
                                                <td><?php echo $etudiant['annee'];?></td>	
                                                
												<td>

                                                
                                                     <a href="etudiant?sup=<?php echo $etudiant['id'];?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                                </td>												
											</tr>
