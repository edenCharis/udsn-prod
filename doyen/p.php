...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="doyen" and isset($_GET["p"])){
...
<h3 class="custom-font"><b> <?php $code = getCodeEnseignant($id,$connexion);
               echo mettrePremieresLettresMajuscules(getPrenomEnseignant($code,$connexion))."  ".strtoupper(getNomEnseignant($code,$connexion));?></b></h3>
