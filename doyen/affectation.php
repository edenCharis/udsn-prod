				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>Affectation des enseignants par classe</h3>
                        </div>
                    </div>
								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from affectation where etab='".$_SESSION['etablissement']."'";
                                          ...
                                          ?>
											<tr>
												...
												<td><?php echo $ue['code_ecue'];?></td>
													<td><?php echo getecue($ue['code_ecue'],$connexion);?></td>
											
												<td><?php echo $ue['classe'];?></td>
                                                <td><?php echo $ue['semestre'];?></td>
                                                <td><?php echo $ue['annee'];?></td>	
                                                <td><?php echo $ue['date_aff'];?></td>	
												<td>

                                                
                                                    <a href="traitement1" class="btn btn-sm btn-primary " data-toggle="modal" data-target="#modifierModal" data-id="<?php echo $ue['id'];?>"
                                                      data-ecue="<?php echo str_replace("+","'",$ue['code_ecue']);?>"  data-classe="<?php echo $ue['classe'];?>"
                                                     data-sem="<?php $ue['semestre'];?>"   data-annee="<?php echo $ue['annee']; ?>"><i class="la la-pencil"></i></a>
                                                    <a href="traitement2?supaff=<?php echo $ue['id'];?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                                </td>												
											</tr>
            ...
            <div class="modal-body">
                ...
                <form  method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="nouveauEcue" class="disabling-options" name="nouveauEcue" >
            ...
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement2">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select id="ecue"  class="disabling-options" name="ecue" >
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from ecue where etab='".$_SESSION['etablissement']."'";
                                                        $resultat=$connexion->query($sql);
                    ...
                    <div class="input-group mb-3">
                       ...
                       <div class="input-group mb-3">
                                            ...
                                            <select id="semestre" class="disabling-options" name="semestre" >
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from semestre ";
                                                        $resultat=$connexion->query($sql);
