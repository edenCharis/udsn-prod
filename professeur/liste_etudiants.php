				...
				<div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>  <i class="fa fa-user-graduate"></i>
 Mes  etudiants</h4>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../professeur/"><?php echo $_GET["classe"]; ?></a></li>
                            <li class="breadcrumb-item active"><a href="etudiants"><?php echo $_GET["annee"]; ?></a></li>
					...
					<div class="col-lg-12">
						<div class="card">
                            ...
                            <div class="basic-form">
                                 <h5> Classe : <?php echo $_GET["classe"]; ?></h5>
                                  <h5> Année-Académique : <?php echo $_GET["annee"]; ?></h5>
                                </div>		
							</div>
							<div class="card-body">
									...
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 ...
                                                 $sql ="select * from inscription where etab='".$_SESSION['etablissement']."' and classe='".$_GET["classe"]."' and annee='".$_GET["annee"]."'";
