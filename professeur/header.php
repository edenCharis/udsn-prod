                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="header-left">
                        ...
                        <ul class="navbar-nav header-right">
                          ...
                          <?php
// Définir l'image par défaut si la session n'est pas définie
$profile_image = isset($_SESSION['img']) && !empty($_SESSION['img']) ? $_SESSION['img'] : 'photos/udsn.png';
?>

<li class="nav-item dropdown header-profile">
    <a class="nav-link" href="#" role="button" data-toggle="dropdown">
        <img src="<?php echo htmlspecialchars($profile_image); ?>" width="20" alt="Profile">
    </a>
